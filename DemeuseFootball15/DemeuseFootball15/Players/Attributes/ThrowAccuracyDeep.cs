...
{
    public class ThrowAccuracyDeep : PlayerAttribute
    {
        [PotentialProperty]
        ...
        public override void Create(Player player, IDiceShaker shaker, IDiceAttribute diceAttribute)
        {
            ...
            {
                value = 12;
                _armStrengthModifier = shaker.RandomRoll(-.5, -.3);
            }
            else if (armStrength > 30 && armStrength <= 40)
            {
                value = 15;
                _armStrengthModifier = shaker.RandomRoll(-.3, -.1);
            }
            ...
            else if (armStrength > 60 && armStrength <= 75)
            {
                ...
                _armStrengthModifier = shaker.RandomRoll(-.1, .1);
            }
