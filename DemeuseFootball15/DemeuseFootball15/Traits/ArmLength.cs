...
{
	/// <summary>
	/// Min and max are in inches
	/// </summary>
	public class ArmLength : RandomizeDependencyTrait
	{
		...
		private void _getGetDefaults()
		{
			...
			doc.Load(@"C:\Development\VS2012\DemeuseFootball15\DemeuseFootball15\HeightToArmLengthRatio.xml");
